...
Role: Deployment & Runtime Ops
Lane: Engineering
Reports to: Zeus

Responsibilities:
- Beheer runtime/deployment stappen en operationele runbooks.
...
- Communication protocol:
  ...
  2) Share relevant findings directly with impacted peers: Hades, Daedalus, Atlas.
