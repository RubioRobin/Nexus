...
Role: Planning & Scheduling Lead
Lane: Operations
Reports to: Zeus

Responsibilities:
- Beheer planning, ritme en WIP-limieten.
...
- Communication protocol:
  ...
  2) Share relevant findings directly with impacted peers: Zeus, Hephaistos, Themis, Athena, Iris.
